...
<div class="page">
   <div class="page-header">
      <h1 class="page-title">Şöbələr</h1>
   </div>
         ...
         <div class="panel-body container-fluid">
            <div class="col-lg-12">
               ...
               <div class="example-wrap">
                  ...
                  <a href="{{route('admin.psubcategories.trashed')}}" class="btn btn-warning btn-sm float-right"><i class="fa fa-trash"></i></a>
                        ...
                        <tbody>
                           ...
                           <tr align="center">
                              ...
                              <td>
                                 ...
                                 <a href="{{route('admin.psubcategories.delete',$subcategory->id)}}" class="btn btn-outline-danger"><i class="fa fa-trash"></i></a>
                              </td>
                           </tr>
                           @endforeach
                        </tbody>
...
<script>
   $(function() {
      $('.edit-click').click(function(){
         ...
         $.ajax({
            type:'GET',
            url:'{{route('admin.psubcategories.getData')}}',
            data:{id:id},
      ...
      $('.status').change(function() {
       ...
       $.get("{{route('admin.psubcategories.status')}}",{id:id,status:status}, function(data, status){
    console.log(data);
       });
     })
   })
...
<div class="modal fade" id="editexampleFormModal" aria-hidden="false" aria-labelledby="exampleFormModalLabel"
   ...
   <div class="modal-dialog modal-simple">
      <form  method="POST" action="{{route('admin.psubcategories.update')}}" class="modal-content" enctype="multipart/form-data">
         @csrf
...
<div class="modal fade" id="exampleFormModal" aria-hidden="false" aria-labelledby="exampleFormModalLabel"
   role="dialog" tabindex="-1">
   <div class="modal-dialog modal-simple">
      <form  method="POST" action="{{route('admin.psubcategories.create')}}" class="modal-content" enctype="multipart/form-data">
         @csrf
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
         ...
         <div class="modal-body">
            <div class="row">
               ...
               <div class="col-xl-12 form-group">
                  <input class="form-control" required="required" name="sira" type="number" max="30" min="1" placeholder="Sıra Əlavə Et" id="faiz" />
               </div>
               <div class="col-md-12 float-right">
